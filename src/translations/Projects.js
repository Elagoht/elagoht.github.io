...
export const errors = {
  ...
  en: [
    ...
    <p>You used Github REST API 60 times in last hour. This is the limit of free tier. Not only for this site. You won't be able to see any web page uses Github REST API.</p>,
    <p>Nothing. Just wait a bit. It should be load later. Do not evenly try refreshing this page.</p>
  ]
}
export const loading = {
  tr: ["Y", "ü", "k", "l", "e", "n", "i", "y", "o", "r", ".", ".", "."],
  en: ["L", "o", "a", "d", "i", "n", "g", ".", ".", "."]
}