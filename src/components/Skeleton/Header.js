    ...
    <div className="flex justify-between m-auto max-w-screen-lg">
      ...
      <div className="flex">
        <motion.div
          ...
          whileTap={{ scale: [1, .8] }}
          transition={{ duration: .15 }}
          className={"cursor-pointer rounded-full w-10 h-10 p-2 m-2 select-none text-center text-zinc-50 " + (language == "en" ? "bg-red-700" : "bg-indigo-700")}
        ...
        <motion.div
          ...
          whileTap={{ scale: [1, .8] }}
          transition={{ duration: .15 }}
          className="cursor-pointer rounded-full bg-zinc-600 w-10 h-10 p-2 m-2"
