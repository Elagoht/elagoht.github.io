  ...
  const gitdocs = [
    {
      ...
      link: "https://github.com/Elagoht/Nasil-Soru-Sorulur",
      badges: {
        tr: [
          "badge/Format-MD-000000?logo=markdown",
          "github/stars/Elagoht/Nasil-Soru-Sorulur?label=Yıldızlar&logo=starship",
          "youtube/views/_tXm0TyAfH0?logo=youtube&label=İzlemeler",
          "youtube/likes/_tXm0TyAfH0?logo=undertale&label=Beğeniler"
        ],
        en: [
          "badge/Format-MD-000000?logo=markdown",
          "github/stars/Elagoht/Nasil-Soru-Sorulur?label=Stars&logo=starship",
          "youtube/views/_tXm0TyAfH0?logo=youtube&label=Views",
          "youtube/likes/_tXm0TyAfH0?logo=undertale&label=Likes"
        ],
      },
      desc: {
        tr: "Türkçe soru sorma kursu. İnsanlar soru sormayı bilmedikleri için çoğu zaman gerekli cevaplara ulaşamıyorlar. Bunun en büyük nedeni de kendilerini ofade etmekteki yetersizlikleri. Bu kurs da etkili soru sormanın tekniklerini öğretiyor.",
        en: "Turkish questioning course.  Because people do not know how to ask questions, they often cannot reach the necessary answers.  The biggest reason for this is their inability to keep themselves busy.  This course also teaches techniques for effective questioning."
      }
    }
  ]
